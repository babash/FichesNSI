...
<h3 data-icon="💡">Opérateurs Logiques (<code>not</code>, <code>and</code>, <code>or</code>)</h3> <p>Ils permettent de combiner ou d'inverser des conditions pour des tests plus complexes.</p>
...
<p><strong>Explication :</strong> La condition est VRAIE car not False est VRAI. On exécute le bloc de code si la variable est Fausse.</p> </subsection> </section>
