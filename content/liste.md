...
<ul>
<li><span>append(element)</span> : ajoute un élément à la fin de la liste.</li>
...
<ul>
<li><span>pop(index)</span> : supprime l'élément à l'index donné et le renvoie. Si l'index est omis, il supprime et renvoie le dernier élément.</li>
